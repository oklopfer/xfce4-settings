...
static void
xfce_displays_helper_x11_iio_sensor_appeared_cb (GDBusConnection *connection,
                                                 const gchar     *name,
                                                 const gchar     *name_owner,
                                                 gpointer         data);
static void
xfce_displays_helper_x11_iio_sensor_vanished_cb (GDBusConnection *connection,
                                                 const gchar     *name,
                                                 gpointer         data);
...
static void
xfce_displays_helper_x11_iio_sensor_apply_rotation (XfceDisplaysHelperX11 *helper,
                                                gint                rotation)
{
    GHashTable *props;
    GHashTableIter iter;
...
static void
xfce_displays_helper_x11_iio_sensor_properties_changed (GDBusProxy *proxy,
                                                    ...
                                                    gpointer    data)
{
    ...
    if (g_variant_dict_contains (&dict, "AccelerometerOrientation"))
    {
        ...
        xfce_displays_helper_x11_iio_sensor_apply_rotation (helper, rotation);
    }
}
                                             ...
                                             gpointer         data)
{
    ...
    g_signal_connect (G_OBJECT (helper->iio_proxy), "g-properties-changed",
                      G_CALLBACK (xfce_displays_helper_x11_iio_sensor_properties_changed), helper);
